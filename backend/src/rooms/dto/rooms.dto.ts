...
export const CreateRoomSchema = z.object({
  ...
  room_type: z.enum(['exam_prep', 'silent_focus', 'night_study', 'subject_specific', 'group_study', 'pomodoro']),
...
export const UpdateRoomSchema = z.object({
  ...
  description: z.string().max(500).optional().nullable(),
  room_type: z.enum(['exam_prep', 'silent_focus', 'night_study', 'subject_specific', 'group_study', 'pomodoro']).optional(),
  subject_id: z.string().uuid().optional().nullable(),
